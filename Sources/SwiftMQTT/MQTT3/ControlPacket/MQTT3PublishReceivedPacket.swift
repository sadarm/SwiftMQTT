...
extension MQTT3 {
    struct PublishReceivedPacket: MQTT3ControlPacket {
        var typeAndFlags: ControlPacketTypeAndFlags { ControlPacketTypeAndFlags(type: .pubrec, flags: 0) }
...
extension MQTT3.PublishReceivedPacket {
